          ...
          <img src="assets/IDAHO.png" alt="State Map of Idaho" width="350" height="541" useMap="#Map"/>
            <map name="Map">
              ...
              <button className="base-btn" onClick={handleBaseClick}>
                ...
                data-location="47.67353439331055,-116.78118896484375" />  
              </button>
            </map> 
        </div>
    )
