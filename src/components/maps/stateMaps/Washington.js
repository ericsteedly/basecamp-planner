      ...
      <img src="assets/WASHINGTON.png" alt="State Map of Washington" width="784" height="518" useMap="#Map"/>
        <map name="Map">
          ...
          <button className="base-btn" onClick={handleBaseClick}>
            ...
            data-location="46.996639251708984,-120.54784393310547" />
          </button>
          <button className="base-btn" onClick={handleBaseClick}>
